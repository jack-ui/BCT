...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 03 sep. 2019 à 09:57
...
(1, '1349857', 'La ferme des Jacques', 'A domicile', 'CB', 'default.jpg', 97, 'Rambouillet', 78120, '10 route de Verdun', '019234758', 78, 'ile de france', 'Une super boutique pour tous les locavores !'),
(61, '102974198247', 'Chez François', 'sur place', 'espèces', NULL, 102, 'Rambouillet', 78120, '10 route de Verdun', '07 38 12 79 02', 78, 'Ile de France', 'Vous aimez les pommes ? On en a ! Et pleins d\'autres choses aussi !'),
(62, '483743843984394717', 'LEROY\'S FARM', 'à emporter', 'espèces', NULL, 103, 'Rambouillet', 78120, '12, chemin Rémy Marty', '06 41 77 53 40', 78, 'Ile de France', 'Bienvenue ! Venez nous rencontrer !'),
(63, '873109382394', 'La ferme de Joseph', 'à domicile', 'cb', NULL, 105, 'Rambouillet', 78710, '37, boulevard Margaux Herve', '07 56 20 94 01', 78, 'Ile de France', 'Les meilleurs légumes de toute la région ! '),
(64, '3928432095798', 'Les bons produits de Margaud', 'sur place', 'espèces', NULL, 108, 'Raizeux', 78125, '44, impasse François Germain', '097974823', 78, 'Ile de France', 'Produits de qualité, accueil avec le sourire, venez nous rencontrer !'),
(65, '095823703294', 'La Ferme du SOleil', 'à domicile', 'espèces', NULL, 111, 'Mantes-La-Jolie', 78200, '7, boulevard Susan Fabre', '07 69 31 25 82', 78, 'Ile de France', 'Des fruits, des légumes, parfois quelques oeufs, de quoi être heureux !'),
(66, '9857298572985798275', 'La Ferme Delanoy', 'point relais', 'paypal', NULL, 113, 'Mantes-La-Jolie', 78200, '580, avenue Pinto', '017835504', 78, 'Ile de France', 'Une ferme familiale pour tous vos besoins. '),
(67, '', 'La ferme des sourires', 'à emporter', 'espèces', NULL, 121, 'Buc', 78530, '3, rue Brun', '01 03 58 81 59', 78, 'Ile de France', 'Venez acheter des produits sains dans une ferme bio familiale ! '),
(68, '3572985723587235', 'La ferme de Susan', 'à emporter', 'espèces', NULL, 122, 'Buc', 78530, '5, boulevard Pereira', '069012972', 78, 'Ile de France', 'Un plein de produits frais et respectueux de l\'environnement dans la bonne humeur !'),
(69, '39473895739857', 'Richard\'s corner', 'à emporter', 'espèces', NULL, 124, 'Buc', 78530, '55, impasse de Bertin', '07 67 16 62 67', 78, 'Ile de France', 'Un petit coin de verdure en région parisienne !'),
(70, '209852019475', 'Chez Hugues', 'point relais', 'cb', NULL, 130, 'Buc', 78530, 'boulevard Regnier', '061590283', 78, 'Ile de France', 'Une ferme où trouver les produits qui feront votre bonheur. '),
(71, '98537935729358279', 'La ferme verte ', 'à domicile', 'paypal', NULL, 132, 'Aubergenville', 78410, '310, boulevard Jeanne Dijoux', '07 80 02 48 51', 78, 'Ile de France', 'Une petite ferme où trouver vos produits bios. '),
(72, '2957250868274', 'Chez Christiane', 'à emporter', 'espèces', NULL, 134, 'Guyancourt', 78280, '9, avenue de Potier', '062592232', 78, 'Ile de France', 'Avec Christiane découvrez les produits que nos ancêtres affectionnaient tant !'),
(73, '8357985729857', 'La ferme aux ânes', 'à domicile', 'cb', NULL, 135, 'Guyancourt', 78280, '97, boulevard Victor Lopez', '067077779', 78, 'Ile de France', 'Une ferme qui respecte l\'environnement et votre santé !'),
(74, '94857928592385', 'La petite ferme de Guyancourt', 'à emporter', 'cb', NULL, 137, 'Guyancourt', 78280, '67, chemin Hugues Grondin', '06 25 00 65 78', 78, 'Ile de France', 'Une ferme traditionnelle qui revient aux valeurs ancestrales. '),
(75, '90234203748357', 'La ferme des Texier', 'domicile', 'paypal', NULL, 142, 'Guyancourt', 78280, 'impasse de Benoit', '01 54 41 74 36', 78, 'Ile de France', 'A la ferme des Texier, trouvez tous les fruits et légumes de saison et de qualité !'),
(76, '38574637569', 'La ferme du pont', 'à emporter', 'espèces', NULL, 146, 'Bazemont', 78580, '1, rue de Albert', '06 39 94 53 58', 78, 'Ile de France', 'Pour des produits frais et écolos, venez ici !'),
(77, '9475987538975', 'La ferme du Maréchal', 'point relais', 'cb', NULL, 147, 'Maule', 78580, '65, chemin de Marechal', '06 39 92 46 05', 78, 'Ile de France', 'Depuis plus de 50 ans la ferme Maréchal nourrit les familles de ses bons produits. '),
(78, '439857387565', 'La ferme Gregoire', 'à emporter', 'espèces', NULL, 155, 'Maule', 78580, '198, impasse Gay', '01 38 32 55 03', 78, 'Ile de France', 'Une petite ferme familiale de qualité à qui vous pouvez faire confiance !'),
(79, '83758375656682', 'La ferme rouge', 'domicile', 'paypal', NULL, 161, 'Maule', 78580, '68, avenue Marchand', '01 88 89 92 61', 78, 'Ile de France', 'Un petit espace de verdure au milieu du béton. '),
(80, '492614789624', 'Les Oliviers', 'à emporter', 'espèces', NULL, 164, 'Maule', 78580, '54, avenue Lorraine Lebrun', '0611158086', 78, 'Ile de France', 'Venez acheter nos délicieux fruits et légumes !'),
(81, '9874938759875683', 'Chez Lopes', 'à emporter', 'espèces', NULL, 169, 'Porcheville', 78440, '154, chemin Susan Louis', '07 57 25 09 49', 78, 'Ile de France', 'Une toute nouvelle ferme familiale qui changera votre manière de consommer ! ');
...
CREATE TABLE IF NOT EXISTS `produit` (
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_29A5EC27DB050607` (`boutiqueId`)
...
INSERT INTO `produit` (`id`, `nom`, `categorie`, `stock`, `prix`, `saisonnalite`, `photo`, `unite_mesure`, `boutiqueId`, `description`) VALUES
...
(771, 'courgettes', 'legume', 8, 2, 'ete', 'courgettes.jpg', 'poids', 1, 'Les meilleur(e)s courgettes de la région !'),
...
(97, 'Jacques', 'Jeannine', 'f', '72, rue Julien Labbe', 'j.jacques@live.com', 'JeannineJ', '`O\"OK5*p\\j66XM', 'Rambouillet', 78120, '0192347586', '1957-07-12', NULL, '1', 1, 'ROLE_USER', 78, 'Ile de France'),
...
(169, 'Lopes', 'Dominique', 'm', '154, chemin Susan Louis', 'dominique_lopes@voila.fr', 'Dominique Lopes', 'i8_MO;#POpR\'VV;@T', 'Porcheville', 78440, '07 57 25 09 49', '1999-04-20', NULL, '1', 81, 'ROLE_USER', 78, 'Ile de France'),
...
--
ALTER TABLE `produit`
  ADD CONSTRAINT `FK_29A5EC27DB050607` FOREIGN KEY (`boutiqueId`) REFERENCES `boutique` (`id`);
