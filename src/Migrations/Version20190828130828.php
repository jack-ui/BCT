 ...
 */
final class Version20190828130828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(30) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(50) NOT NULL, prenom VARCHAR(30) NOT NULL, nom VARCHAR(30) NOT NULL, sexe VARCHAR(1) NOT NULL, ville VARCHAR(50) NOT NULL, code_postal INT NOT NULL, adresse LONGTEXT NOT NULL, telephone VARCHAR(17) NOT NULL, date_de_naissance DATE NOT NULL, role VARCHAR(20) NOT NULL, salt VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
